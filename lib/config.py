...
__C.DIR.SHAPENET_QUERY_PATH = './ShapeNet/ShapeNetVox16/'
__C.DIR.MODEL_PATH = './ShapeNet/ShapeNetCore.v1/%s/%s/model.obj'
__C.DIR.VOXEL_PATH = './ShapeNet/ShapeNetVox16/%s/%s/model.binvox'
__C.DIR.RENDERING_PATH = './ShapeNet/ShapeNetRender16/%s/%s/rendering'
...
__C.TRAIN.SAVE_FREQ = 1000  #changed from 10000 # weights will be overwritten every save_freq
